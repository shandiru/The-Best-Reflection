...
const services = [
  {
    ...
    desc: "Ultimate invisible shield against stone chips, scratches, and road debris with self-healing technology.",
    image: "/ppf-protection.avif",
    path: "/services/ppf",
  },
  {
    title: "CERAMIC COATING",
    desc: "Advanced liquid polymer coating that bonds to your PPF or paint for extreme gloss and hydrophobic protection.",
    image: "/ceramic-coating.avif",
    path: "/services/ceramic-coating",
  },
  {
    title: "PAINT CORRECTION",
    desc: "Precision machine polishing to remove swirls and imperfections before applying PPF for a flawless finish.",
    image: "/paint-correction.avif",
