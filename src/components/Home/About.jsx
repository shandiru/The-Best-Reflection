...
const testimonials = [
{
    "text": "The finish is absolutely incredible! My car looks like it just rolled out of the showroom. Their attention to detail really lives up to the name 'The Best Reflection'.",
